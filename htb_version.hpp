...
namespace htb{
	...
	static const long VER_REVISION  = 613;
	
	//Miscellaneous Version Types
	static const long VER_BUILDS_COUNT  = 718;
	#define VER_RC_FILEVERSION 1,9,13,613
	#define VER_RC_FILEVERSION_STRING "1, 9, 13, 613\0"
	static const char VER_FULLVERSION_STRING [] = "1.9.13.613";
