...
namespace htb{
	...
	static const long VER_BUILD  = 35;
	static const long VER_REVISION  = 213;
	
	//Miscellaneous Version Types
	static const long VER_BUILDS_COUNT  = 347;
	#define VER_RC_FILEVERSION 1,0,35,213
	#define VER_RC_FILEVERSION_STRING "1, 0, 35, 213\0"
	static const char VER_FULLVERSION_STRING [] = "1.0.35.213";
