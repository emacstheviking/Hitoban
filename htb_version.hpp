...
namespace htb{
	...
	static const long VER_BUILD  = 23;
	static const long VER_REVISION  = 134;
	
	//Miscellaneous Version Types
	static const long VER_BUILDS_COUNT  = 261;
	#define VER_RC_FILEVERSION 1,0,23,134
	#define VER_RC_FILEVERSION_STRING "1, 0, 23, 134\0"
	static const char VER_FULLVERSION_STRING [] = "1.0.23.134";
	
	//These values are to keep track of your versioning state, don't modify them.
	static const long VER_BUILD_HISTORY  = 23;
