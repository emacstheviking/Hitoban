...
namespace htb{
	...
	static const long VER_REVISION  = 85;
	
	//Miscellaneous Version Types
	static const long VER_BUILDS_COUNT  = 198;
	#define VER_RC_FILEVERSION 1,0,14,85
	#define VER_RC_FILEVERSION_STRING "1, 0, 14, 85\0"
	static const char VER_FULLVERSION_STRING [] = "1.0.14.85";
	
	//These values are to keep track of your versioning state, don't modify them.
	static const long VER_BUILD_HISTORY  = 14;
