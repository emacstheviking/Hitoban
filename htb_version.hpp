...
namespace htb{
	...
	static const long VER_BUILD  = 1;
	static const long VER_REVISION  = 557;
	
	//Miscellaneous Version Types
	static const long VER_BUILDS_COUNT  = 687;
	#define VER_RC_FILEVERSION 1,8,1,557
	#define VER_RC_FILEVERSION_STRING "1, 8, 1, 557\0"
	static const char VER_FULLVERSION_STRING [] = "1.8.1.557";
	
	//These values are to keep track of your versioning state, don't modify them.
	static const long VER_BUILD_HISTORY  = 40;
