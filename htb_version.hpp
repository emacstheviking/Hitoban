...
namespace htb{
	...
	static const long VER_BUILD  = 39;
	static const long VER_REVISION  = 230;
	
	//Miscellaneous Version Types
	static const long VER_BUILDS_COUNT  = 365;
	#define VER_RC_FILEVERSION 1,0,39,230
	#define VER_RC_FILEVERSION_STRING "1, 0, 39, 230\0"
	static const char VER_FULLVERSION_STRING [] = "1.0.39.230";
