...
OBJ_DEBUG = $(OBJDIR_DEBUG)/ext_libs/md5/md5.o $(OBJDIR_DEBUG)/hitoban.o $(OBJDIR_DEBUG)/htb_functions.o $(OBJDIR_DEBUG)/htb_stdlib.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/ext_libs/md5/md5.o $(OBJDIR_RELEASE)/hitoban.o $(OBJDIR_RELEASE)/htb_functions.o $(OBJDIR_RELEASE)/htb_stdlib.o
...
before_debug: 
	...
	test -d $(OBJDIR_DEBUG)/ext_libs/md5 || mkdir -p $(OBJDIR_DEBUG)/ext_libs/md5
...
$(OBJDIR_DEBUG)/ext_libs/md5/md5.o: ext_libs/md5/md5.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c ext_libs/md5/md5.cpp -o $(OBJDIR_DEBUG)/ext_libs/md5/md5.o
...
clean_debug: 
	...
	rm -rf bin/Debug
	rm -rf $(OBJDIR_DEBUG)/ext_libs/md5
	rm -rf $(OBJDIR_DEBUG)

before_release: 
	test -d bin/Release || mkdir -p bin/Release
	test -d $(OBJDIR_RELEASE)/ext_libs/md5 || mkdir -p $(OBJDIR_RELEASE)/ext_libs/md5
...
$(OBJDIR_RELEASE)/ext_libs/md5/md5.o: ext_libs/md5/md5.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c ext_libs/md5/md5.cpp -o $(OBJDIR_RELEASE)/ext_libs/md5/md5.o
...
clean_release: 
	...
	rm -rf bin/Release
	rm -rf $(OBJDIR_RELEASE)/ext_libs/md5
