...
OBJ_DEBUG = $(OBJDIR_DEBUG)/hitoban.o $(OBJDIR_DEBUG)/htb_functions.o $(OBJDIR_DEBUG)/htb_stdlib.o $(OBJDIR_DEBUG)/htb_tests.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/hitoban.o $(OBJDIR_RELEASE)/htb_functions.o $(OBJDIR_RELEASE)/htb_stdlib.o $(OBJDIR_RELEASE)/htb_tests.o
